...
namespace MVCTutorial.Controllers
{
    ...
    {
        private CustomersControllerContext db = new CustomersControllerContext();

        // GET: Orders
        public ActionResult Index()
        {
            var orders = db.Orders.Include(o => o.Customer); //this is where customer instance gets merged with customers
